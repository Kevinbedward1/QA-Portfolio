...
**Observed:** Accepted as valid. The name field doesn’t restrict numeric-only input.
**Noticed/Risk**: Users can enter invalid names, compromising data integrity. Users will enter information into the system, causing inefficiencies in the hotel’s operation. 
**Question:** Should the Name field restrict input to alphabetic characters, or is numeric input allowed?

**Tried:** Entered [kbedward.com](http://kbedward.com) into the email address field - 
**Observed**: received an error message: “must be a well-formed email address”.
...
**Noticed:** Users can enter a subject that doesn’t have anything to do with the Hotel which reduces the usefulness of submissions. 
**Question:** Is it intentional for the Subject field to be opened without any restrictions, or should it have a dropdown menu with predefined options? 
